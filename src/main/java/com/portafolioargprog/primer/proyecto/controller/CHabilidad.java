...
import com.portafolioargprog.primer.proyecto.dto.dtoHabilidad;
import com.portafolioargprog.primer.proyecto.entity.Habilidad;
import com.portafolioargprog.primer.proyecto.service.SHabilidad;
import com.portafolioargprog.primer.Security.Controller.Mensaje;
...
public class CHabilidad {
    ...
    public ResponseEntity<?> create(@RequestBody dtoHabilidad dtohys) {
        ...
        if (shabilidad.existsByNombre(dtohys.getNombre())) {
